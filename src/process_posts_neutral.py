...
LOG_FILE = "/users/addr777/archive/development/llm/data/output/classification_process_neutral.log"
logging.basicConfig(
    filename=LOG_FILE,
    level=logging.INFO,
...
NEGATIVE_POSTS_FILE = "/users/addr777/archive/development/llm/data/neutral_posts.csv"
OUTPUT_FILE = "/users/addr777/archive/development/llm/data/output/classified_neutral_posts_hpc.csv"
PROCESSED_FILE = "/users/addr777/archive/development/llm/data/processed_posts_neutral.txt"  # File to track processed posts
...
def process_posts(input_file, output_file, max_posts=20):
    ...
    with open(input_file, mode='r', encoding='utf-8') as infile, \
         open(output_file, mode='a', newline='', encoding='utf-8') as outfile:  # Append mode to continue from previous data
